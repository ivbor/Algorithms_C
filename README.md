...
* Generic search helpers: binary search/bounds (`ac_binary_search`, `ac_lower_bound`, `ac_upper_bound`), jump search (`ac_jump_search_int`), exponential search (`ac_exponential_search_int`), and integer interpolation search (`ac_interpolation_search_int`).
