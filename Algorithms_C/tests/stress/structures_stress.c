...
#include "reference_deque_model.h"
...
static int run_vector_stress(void) {
    ...
    clock_t start = clock();
    size_t iteration;
    for (iteration = 0; iteration < VECTOR_ITERATIONS; ++iteration) {
...
static int run_slist_stress(void) {
    ...
    clock_t start = clock();
    size_t iteration;
    for (iteration = 0; iteration < SLIST_ITERATIONS; ++iteration) {
        int operation = rand() % 9;
        switch (operation) {
            case 0: {  // append
                int value = rand();
...
static int run_deque_stress(void) {
    ...
    clock_t start = clock();
    size_t iteration;
    for (iteration = 0; iteration < DEQUE_ITERATIONS; ++iteration) {
...
static int run_queue_stress(void) {
    ...
    clock_t start = clock();
    size_t iteration;
    for (iteration = 0; iteration < QUEUE_ITERATIONS; ++iteration) {
...
static int run_stack_stress(void) {
    ...
    clock_t start = clock();
    size_t iteration;
    for (iteration = 0; iteration < STACK_ITERATIONS; ++iteration) {
